...
export const AGENTS = [
    {
        ...
        image: ankor_profile,
        description: 'Define la esencia, misión, visión y valores de tu marca. Es quien aterriza los conceptos abstractos en decisiones prácticas, ayudándote a construir una identidad coherente que conecte con tu audiencia.',
        expertise: [
            'Identidad de marca',
    ...
    },
    {
        ...
        image: sira_profile,
        description: 'Rastrea tendencias, analiza competidores y detecta patrones de mercado. Transforma datos dispersos en insights claros para que tomes decisiones informadas con total claridad.',
        expertise: [
    ...
    },
    {
        ...
        image: nexo_profile,
        description: 'Conecta ideas que nadie había conectado antes. Genera conceptos, campañas y hooks con un enfoque creativo que rompe patrones y captura la atención de tu audiencia.',
        expertise: [
    ...
    },
    {
        ...
        description: 'Diseña el plan a 6-12 meses con prioridades claras. Traduce objetivos en acciones ordenadas en el tiempo, conectando cada iniciativa con los resultados que importan.',
        expertise: [
    ...
    },
    {
        ...
        description: 'Convierte números en decisiones. Construye dashboards, diseña experimentos y te ayuda a entender qué funciona de verdad detrás de cada métrica de tu marca.',
        expertise: [
