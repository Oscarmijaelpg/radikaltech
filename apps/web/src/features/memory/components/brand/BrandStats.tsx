  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
      ...
      <Card className="p-4 sm:p-6 bg-white border-white">
        ...
        {brand?.voice_tone ? (
          <ExpandableContent title="Tono de voz" icon="record_voice_over">
            <p className="font-display text-lg sm:text-xl font-black text-slate-900 mb-2">
            ...
            {brand.visual_direction && (
              <div className="mt-4 pt-4 border-t border-slate-100">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Dirección Visual</p>
      ...
      <Card className="p-4 sm:p-6 bg-gradient-to-br from-cyan-50 to-pink-50 border-white sm:col-span-2 md:col-span-1">
        ...
        {brand?.target_audience ? (
          <ExpandableContent title="Audiencia" icon="groups" maxHeight="max-h-[100px]">
            <p className="text-sm text-slate-700 font-medium leading-relaxed">
              {brand.target_audience}
            </p>
          </ExpandableContent>
