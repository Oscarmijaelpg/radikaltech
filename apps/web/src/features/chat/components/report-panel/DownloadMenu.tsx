...
export function DownloadMenu({ content, structuredData }: Props) {
  ...
  return (
    <div className="p-3 sm:p-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3">
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverPortal>
          <PopoverContent
            ...
            className="w-48 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200"
          >
            <button
              type="button"
              onClick={handlePDF}
